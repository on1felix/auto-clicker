...
const PresenceChild = ({ children, initial: initial2, isPresent, onExitComplete, custom, presenceAffectsLayout, mode }) => {
...
const AnimatePresence = ({ children, custom, initial: initial2 = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false }) => {
  ...
  return jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: renderedChildren.map((child) => {
    ...
    return jsxRuntimeExports.jsx(PresenceChild, { isPresent, initial: !isInitialRender.current || initial2 ? void 0 : false, custom: isPresent ? void 0 : custom, presenceAffectsLayout, mode, onExitComplete: isPresent ? void 0 : onExit, children: child }, key);
  }) });
};
...
class VisualElement {
  ...
  getBaseTarget(key) {
    ...
    if (typeof initial2 === "string" || typeof initial2 === "object") {
      const variant = resolveVariantFromProps(this.props, initial2, (_a = this.presenceContext) === null || _a === void 0 ? void 0 : _a.custom);
      if (variant) {
...
function TitleBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "drag relative flex h-10 items-center justify-between px-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2.5 w-2.5 rounded-full bg-gradient-to-br from-accent-cyan to-accent-violet shadow-[0_0_10px_rgba(34,211,238,0.6)]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-semibold uppercase tracking-[0.18em] text-slate-300/80", children: "Auto Clicker" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "no-drag flex items-center gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(WindowButton, { onClick: handlePin, active: pinned, title: "Always on top", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pin, { className: "h-3.5 w-3.5" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(WindowButton, { onClick: () => window.api.minimizeWindow(), title: "Minimize", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Minus, { className: "h-3.5 w-3.5" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(WindowButton, { onClick: () => window.api.closeWindow(), danger: true, title: "Close", children: /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-3.5 w-3.5" }) })
    ] })
  ] });
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.button,
    {
      ...
      className: [
        ...
        active ? "border-accent-cyan/40 bg-accent-cyan/15 text-accent-cyan" : "border-white/5 bg-white/[0.03] text-slate-400 hover:text-slate-100",
...
function GlassFrame({ active, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-full w-full", style: { padding: "2px" }, children: [
...
function AnimatedMesh({ intense = false }) {
  const speed = intense ? 0.6 : 1;
  const opacity = intense ? 0.85 : 0.6;
  const opacityTransition = { duration: 1.4, ease: "easeOut" };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pointer-events-none absolute inset-0 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-bg-deep via-bg-base to-bg-mid" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            style: {
              background: "radial-gradient(circle, rgba(34,211,238,0.45) 0%, rgba(167,139,250,0.25) 50%, transparent 70%)"
            },
...
function ActivationButton({ active, onToggle }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-center", style: { width: 170, height: 170 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: active && /* @__PURE__ */ jsxRuntimeExports.jsx(ActivePulse, {}, "pulse") }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.button,
      {
        ...
        style: {
          background: "radial-gradient(circle at 30% 30%, rgba(255,255,255,0.12), rgba(255,255,255,0.04) 70%)",
          boxShadow: "0 10px 40px rgba(0,0,0,0.45), inset 0 1px 0 rgba(255,255,255,0.1)"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              transition: { duration: active ? 1 : 0.9, ease: "easeOut" },
              style: {
                background: "radial-gradient(circle at 30% 30%, rgba(34,211,238,0.35), rgba(167,139,250,0.18) 70%)",
                boxShadow: "0 0 60px rgba(34,211,238,0.45), inset 0 0 30px rgba(167,139,250,0.25)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: active ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Square, { className: "h-7 w-7 fill-white text-white" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-[0.3em] text-white/90", children: "Stop" })
              ]
            },
            "stop"
          ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              className: "relative z-10 flex flex-col items-center gap-1.5",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Power, { className: "h-8 w-8 text-slate-100", strokeWidth: 2.4 }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-bold uppercase tracking-[0.3em] text-slate-200", children: "Start" })
              ]
            },
            "start"
          ) })
...
function SegmentedTabs({ options, value, onChange, layoutId }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex rounded-xl border border-white/5 bg-black/30 p-1", children: options.map((opt) => {
      ...
      "button",
      {
        ...
        children: [
          selected && /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              style: {
                ...
                boxShadow: "0 4px 16px rgba(34,211,238,0.15), inset 0 1px 0 rgba(255,255,255,0.08)"
              },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
              className: `relative z-10 flex min-w-0 items-center justify-center gap-1 whitespace-nowrap transition-colors ${selected ? "text-white" : "text-slate-400 hover:text-slate-200"}`,
              children: [
                opt.icon,
...
function GlassCard({ children, label, className = "" }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      layout: true,
      ...
      children: [
        label && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-1.5 flex items-center justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-semibold uppercase tracking-[0.18em] text-slate-400/80", children: label }) }),
        children
      ]
    }
  );
...
function ModeTabs({ value, onChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { label: "Activation mode", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    SegmentedTabs,
    {
      layoutId: "mode-tabs",
      value,
      onChange,
      options: [
        { value: "toggle", label: "Toggle", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Repeat, { className: "h-3 w-3" }) },
        { value: "hold", label: "Hold", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Hand, { className: "h-3 w-3" }) }
      ]
    }
  ) });
}
function TargetTabs({ value, onChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { label: "Target", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    SegmentedTabs,
    {
      ...
      onChange,
      options: [
        { value: "mouse", label: "Mouse", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Mouse, { className: "h-3 w-3" }) },
        { value: "keyboard", label: "Keyboard", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Keyboard, { className: "h-3 w-3" }) }
      ]
    }
  ) });
}
...
function MouseSettings({ button, clickType, onButtonChange, onClickTypeChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { label: "Mouse", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Button", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Chips, { value: button, options: BUTTONS, onChange: onButtonChange }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Row, { label: "Click type", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Chips, { value: clickType, options: TYPES, onChange: onClickTypeChange }) })
  ] }) });
}
function Row({ label, children }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-medium text-slate-400", children: label }),
    children
  ] });
}
function Chips({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: options.map((opt) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.button,
      {
        ...
        whileTap: { scale: 0.96 },
        onClick: () => onChange(opt.value),
        className: `relative rounded-lg border px-3 py-1.5 text-[11px] font-semibold transition-colors ${selected ? "border-accent-cyan/40 bg-accent-cyan/15 text-white" : "border-white/5 bg-white/[0.03] text-slate-400 hover:text-slate-100"}`,
        style: selected ? { boxShadow: "0 0 14px rgba(34,211,238,0.25)" } : void 0,
        children: opt.label
      },
      opt.value
    );
...
function KeyboardSettings({ keyToSend, onChange }) {
  ...
  const handleKey = (e) => {
    ...
    e.preventDefault();
    e.stopPropagation();
    const v2 = e.key === " " ? "Space" : e.key.length === 1 ? e.key.toUpperCase() : e.key;
    onChange(v2);
    setListening(false);
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { label: "Keyboard", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref: boxRef,
      tabIndex: 0,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-[11px] text-slate-400", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Keyboard, { className: "h-3.5 w-3.5" }),
          "Key to send"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", initial: false, children: listening ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.button,
          {
          ...
          motion.button,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.span,
              {
                ...
                transition: { duration: 0.18, ease: "easeOut" },
                className: "inline-block",
                children: keyToSend === " " ? "Space" : keyToSend
              },
              keyToSend
            )
          },
...
function IntervalSlider({ value, onChange, min = 5, max = 1e3 }) {
  const logMin = Math.log10(min);
  const logMax = Math.log10(max);
  const logVal = Math.log10(Math.max(min, Math.min(max, value)));
  const pct = (logVal - logMin) / (logMax - logMin) * 100;
  const handleChange = (rangePct) => {
    const lv = logMin + rangePct / 100 * (logMax - logMin);
    const ms = Math.round(Math.pow(10, lv));
    onChange(ms);
  };
  const cps = (1e3 / Math.max(1, value)).toFixed(value < 50 ? 1 : 0);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { label: "Interval", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Timer, { className: "h-4 w-4 text-accent-cyan" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 rounded-full bg-white/5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          ...
          style: {
            ...
            boxShadow: `0 0 ${8 + (100 - pct) * 0.2}px rgba(34,211,238,${0.25 + (100 - pct) * 4e-3})`
          },
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-[78px] flex-col items-end leading-none", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-semibold uppercase text-slate-500", children: "ms" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[9px] uppercase tracking-wider text-slate-500", children: [
        "≈ ",
        cps,
        " cps"
      ] })
...
function AnvToggle({ value, onChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: "glass relative flex items-center gap-3 rounded-2xl px-3 py-2",
      style: {
        boxShadow: "0 6px 24px -8px rgba(0,0,0,0.35), inset 0 1px 0 rgba(255,255,255,0.06)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex h-9 w-9 items-center justify-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              className: "pointer-events-none absolute inset-0 rounded-full",
              ...
              style: {
                background: "radial-gradient(circle, rgba(34,211,238,0.55) 0%, rgba(167,139,250,0.35) 45%, transparent 70%)",
                filter: "blur(8px)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.div,
            {
              ...
              animate: {
                scale: value ? 1.08 : 1,
                filter: value ? "drop-shadow(0 0 6px rgba(34,211,238,0.9)) drop-shadow(0 0 10px rgba(167,139,250,0.55))" : "drop-shadow(0 0 0px rgba(0,0,0,0))"
              },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-w-0 flex-1 flex-col leading-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-bold tracking-[0.22em] text-white", children: "ANV" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: value && /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.span,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1 text-[9px] uppercase tracking-[0.14em] text-slate-500", children: "Anti-detection jitter" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(NeonSwitch, { value, onChange })
      ]
    }
  );
}
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.span,
          {
            ...
            initial: false,
            animate: {
              background: value ? "linear-gradient(135deg, rgba(34,211,238,0.42), rgba(167,139,250,0.42))" : "rgba(255,255,255,0.06)",
              borderColor: value ? "rgba(34,211,238,0.55)" : "rgba(255,255,255,0.08)",
              boxShadow: value ? "0 0 14px rgba(34,211,238,0.55), 0 0 22px rgba(167,139,250,0.35), inset 0 1px 0 rgba(255,255,255,0.12)" : "inset 0 1px 0 rgba(255,255,255,0.05)"
            },
            transition: { duration: 0.45, ease: "easeOut" },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.span,
          {
            ...
            style: {
              ...
              boxShadow: "0 2px 6px rgba(0,0,0,0.45), inset 0 1px 0 rgba(255,255,255,0.5)"
            },
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.span,
              {
                ...
                transition: { duration: 0.55, ease: "easeOut" },
                style: {
                  background: "radial-gradient(circle at 30% 30%, #e0fbff, #c7d2fe 70%)",
                  boxShadow: "0 0 6px rgba(125,211,252,0.55), inset 0 1px 0 rgba(255,255,255,0.55)"
                }
              }
            )
          }
...
function bindLabel(bind, placeholder = "Not set") {
  if (!bind) return placeholder;
  if (bind.kind === "keyboard") return bind.label;
  return `Mouse ${bind.button}`;
}
function BindChip({ label, bind, capturing, onCapture, placeholder }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", initial: false, children: capturing ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.button,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.span,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Mouse, { className: "h-3 w-3 animate-pulse" }),
              "Press key or mouse…"
            ]
          }
        )
      ...
      motion.button,
      {
        ...
        style: {
          boxShadow: hover2 ? "0 0 16px rgba(167,139,250,0.35)" : "0 0 10px rgba(167,139,250,0.12)"
        },
        children: bindLabel(bind, placeholder)
      },
      "chip"
    ) })
  ] });
}
function StartBindCard({ bind, capturing, onCapture }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(GlassCard, { label: "Trigger bind", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    BindChip,
    {
      label: "Start / stop",
      bind,
...
function HoldBindCard({ holdBind, capturing, onCapture }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassCard, { label: "Hold bind", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      BindChip,
      {
        label: "Hold to click",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 text-[10px] leading-snug text-slate-500", children: [
      "Pick a key or mouse side button. Don't bind the same button the clicker is sending, or you may lock yourself out. Press ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-accent-cyan", children: "Esc" }),
      " anytime to panic-stop."
    ] })
  ] });
}
function formatDuration(ms) {
  ...
  const s = sec % 60;
  if (h > 0) return `${h}h${m2}m${s}s`;
  if (m2 > 0) return `${m2}m${s}s`;
  return `${s}s`;
}
function LiveBanner({ state }) {
  const [runtime, setRuntime] = reactExports.useState(0);
  reactExports.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "h-3 w-3 text-accent-cyan" }), value: state.measuredCps.toString(), label: "cps", accent: true }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Divider, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Target, { className: "h-3 w-3 text-slate-400" }), value: state.totalClicks.toLocaleString(), label: "clicks" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Divider, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Stat, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-3 w-3 text-slate-400" }), value: formatDuration(runtime), label: "time" })
      ]
    }
  );
}
function Divider() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-3 w-px bg-white/10" });
}
function Stat({
  icon,
  value,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-semibold uppercase tracking-wider text-slate-500", children: label })
  ] });
}
function App() {
  ...
  if (!hydrated || !settings) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-screen w-screen items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-slate-500", children: "Loading…" }) });
  }
  ...
  const bindLabel2 = activeBind ? activeBind.kind === "keyboard" ? activeBind.label : `Mouse ${activeBind.button}` : "—";
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative h-screen w-screen overflow-hidden rounded-[24px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(GlassFrame, { active: state.active, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatedMesh, { intense: state.active }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex h-full flex-col", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center px-5 pb-2 pt-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ActivationButton, { active: state.active, onToggle: toggle }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 flex h-7 items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: state.active ? /* @__PURE__ */ jsxRuntimeExports.jsx(LiveBanner, { state }, "banner") : /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.p,
          {
            ...
            children: settings.mode === "hold" && !settings.holdBind ? "Set a hold bind below" : `${bindLabel2} → ${settings.mode === "hold" ? "hold" : "toggle"}  ·  Esc = stop`
          },
          "hint"
        ) }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "no-drag flex-1 space-y-2 overflow-hidden px-4 pb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ModeTabs, { value: settings.mode, onChange: (mode) => update({ mode }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TargetTabs, { value: settings.target, onChange: (target) => update({ target }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          IntervalSlider,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: settings.target === "mouse" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
        ...
        settings.mode === "toggle" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          StartBindCard,
          {
