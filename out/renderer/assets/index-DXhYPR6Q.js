  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-center", style: { width: 170, height: 170 }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.button,
      {
        ...
        style: {
          background: active ? "radial-gradient(circle at 30% 30%, rgba(34,211,238,0.35), rgba(167,139,250,0.18) 70%)" : "radial-gradient(circle at 30% 30%, rgba(255,255,255,0.12), rgba(255,255,255,0.04) 70%)",
          boxShadow: active ? "0 0 60px rgba(34,211,238,0.45), inset 0 0 30px rgba(167,139,250,0.25)" : "0 10px 40px rgba(0,0,0,0.45), inset 0 1px 0 rgba(255,255,255,0.1)"
        },
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: active ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
